...
type
  ...
  public
    ...
    procedure Delete(const AIndex: Integer; FreeNode: Boolean = True);
    ...
    property BindLayout: TControl read FBindLayout write FBindLayout;
  end;
...
procedure TYogaNode.Delete(const AIndex: Integer; FreeNode: Boolean);
var
  Child: TYogaNode;
begin
